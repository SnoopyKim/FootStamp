...
val listOfArea: Map<String, List<String>> = mapOf(
    "동부" to listOf("강동구", "광진구", "동대문구", "성동구", "중랑구"),
    "서부" to listOf("강서구", "구로구", "금천구", "양천구", "영등포구"),
    "남부" to listOf("강남구", "관악구", "동작구", "서초구", "송파구"),
    "북부" to listOf("강북구", "노원구", "도봉구", "성북구"),
    "중부" to listOf("마포구", "서대문구", "용산구", "은평구", "종로구", "중구")
)
